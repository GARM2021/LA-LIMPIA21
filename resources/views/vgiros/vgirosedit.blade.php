    ...
    <div class="content">
        ...
        <form method="POST" action="{{ route('giros.update', ['giro' => $giro->giro]) }}">
            ...
            <div class="form-row">
                ...
                <input class="form-control" type="text" name="nomgiro" value="{{ old('nomgiro') ?? $giro->nomgiro }}"
                    required>
            </div>
            <div class="form-row">
                <label>Causa Recargo SI/NO</label>
                <input class="form-control" type="text" name="causarec" value="{{ old('causarec') ?? $giro->causarec }}"
                    required>
            </div>
