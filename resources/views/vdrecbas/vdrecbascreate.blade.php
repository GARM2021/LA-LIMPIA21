                ...
                <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <input class="form-control" type="text" name="fnotifica" value="{{ old('fnotifica') }}"
                                requiered>
                            <label>Gestor</label>
                            <input class="form-control" type="number" name="gestor" value="{{ old('gestor') }}"
                                requiered>
                            ...
                            <input class="form-control" type="number" name="cvereq" value="{{ old('cvereq') }}"
                                requiered>
                            <label>Fecha de Embargo</label>
                            <input class="form-control" type="text" name="fembargo" value="{{ old('fembargo') }}"
                                requiered>

                            <label>Grupo</label>
                            <input class="form-control" type="number" name="grupo" value="{{ old('grupo') }}"
                                requiered>
                            <label>Tipo</label>
