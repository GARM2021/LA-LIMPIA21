    ...
    <div class="content">
        ...
        <form method="POST" action="{{ route('recargos.update', ['recargo' => $recargo->ayo]) }}">
            ...
            <div class="form-row">
                ...
                <input class="form-control" type="number" name="pctajerec"
                    value="{{ old('pctajerec') ?? $recargo->pctajerec }}" required>
            </div>
            <div class="form-row">
                <label>Porcentaje de Recargos 2</label>
                <input class="form-control" type="number" name="pctajerec2"
                    value="{{ old('pctajerec2') ?? $recargo->pctajerec2 }}" required>
            </div>
