    ...
    <form method="POST" action="{{route('categos.update', ['catego' => $catego->catego] )}}">
      @csrf 
        ...
        <div class="form-row"> 
            ...
            <input class="form-control" type="text" name="descripcion" value="{{ old('descripcion') ?? $catego->catego}}" required>
        </div>
        <div class="form-row"> 
            <label>Tarifa</label>
            <input class="form-control" type="number" name="tarifa" value="{{ old('tarifa') ?? $catego->tarifa}}" required>
        </div>
        <div class="form-row"> 
            <label>Kilos</label>
            <input class="form-control" type="number" name="kilos" value="{{ old('kilos') ?? $catego->kilos}}" required>
        </div>
